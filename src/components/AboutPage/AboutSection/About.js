            ...
            <div className='about_info_container'>
                ...
                <div className='about_button_section'>
                    ...
                    <div className='social_media_link'>
                        <a target="_blank" href='https://www.linkedin.com/in/pierre-andr%C3%A9-louis-3a64a6279/'><img alt='this is a media icon' className="fiverr_logo" src={LINKEDIN_LOGO} /></a>
                        <a target="_blank" href="https://www.fiverr.com/webdeveloper_pr" > <img alt='this is a media icon' className="fiverr_logo" src={FIVER_LOGO} /></a>
                        <a target="_blank" href='https://www.upwork.com/freelancers/~017c6fdbed2e590223' ><img alt='this is a media icon' className="upwork_logo" src={UPWORK_LOGO} /></a>
                        <a target="_blank" href='https://wa.me/50946731710' ><img alt='this is a media icon' className="fiverr_logo" src={WHATSAPP_LOGO} /></a>
                    </div>
                </div>
